...
void excluirEmbarque(vector<Embarca> &embarques, vector<Passageiro> passageiros, char cod[12]);
...
void listarEmbarquesRoteiro(vector<Embarca> &vecResult, vector<Embarca> embarques, char cod[12]);
...
void gestaoPassageiro(vector<Passageiro> &passageiros)
{
    ...
    {
        cout << endl
             << "Menu de Gestão de passageiros:" << endl;
        cout << "1 - Incluir" << endl;
        cout << "2 - Excluir" << endl;
...
void gestaoRoteiro(vector<Roteiro> &roteiros)
{
    ...
    do
    {
        codigo[12] = {0};
        cout << endl
             << "Menu de Gestão de roteiros:" << endl;
        cout << "1 - Incluir" << endl;
        cout << "2 - Excluir" << endl;
...
void gestaoEmbarque(vector<Embarca> &embarques, vector<Passageiro> passageiros, vector<Roteiro> roteiros)
{
    ...
    {
        cout << endl
             << "Menu de Gestão de embarques:" << endl;
        cout << "1 - Incluir" << endl;
        cout << "2 - Excluir" << endl;
        cout << "3 - Alterar" << endl;
        cout << "4 - Listar" << endl;
        ...
        case 2:
            ...
            cin >> cod;
            excluirEmbarque(embarques,passageiros,cod);
            break;
        case 3:
...
void excluirEmbarque(vector<Embarca> &embarques, vector<Passageiro> passageiros, char cod[12])
{
    ...
    if (embarques.size() != 0)
    {
        // cria um vetor com os passageiros que embarcaram no roteiro
        listPass = listarPassageirosEmbarque(embarques, passageiros, cod);
        cout << "Passageiros que embarcaram no roteiro: " << cod << endl;
        listarPassageiros(listPass);

        // solicita cpf que esteja presente na lista de passageiros do roteiro
        do
        {
            cout << "Digite CPF do Passageiro a ser excluido do roteiro: ";
            cin >> cpf;
            valID = validaCPF(cpf);
            unicoID = cpfUnico(listPass, cpf);
            if (!valID)
        ...
        // remove embarque
        embarques.erase(embarques.begin() + posicao);
        cout << "Embarque excluido com sucesso." << endl;
    }
    else
        cout << "Não há nenhum embarque registrado.\n";
}
...
void listarOcorrenciasRoteiro(vector<Embarca> &embarques, vector<Roteiro> Roteiros){
    char codigo[12];
    bool valID, unicoID;
    vector<Embarca> embarquesRoteiro;

    do{
        cout << "Digite codigo do Roteiro: ";
        cin >> codigo;
        valID = validaCod(codigo);
        unicoID = codUnico(Roteiros, codigo);
        if (!valID)
            cout << "Codigo inválido." << endl;
        else if (unicoID)
            cout << "Codigo nao cadastrado." << endl;
    ...
    listarEmbarquesRoteiro(embarquesRoteiro, embarques, codigo);

    if(embarquesRoteiro.size() == 0){
        cout << "Roteiro não possui embarques cadastrados" << endl;
    }else{
        cout << "Ocorrencias do roteiro: ";
        buscarRoteiros(Roteiros, codigo);
...
void listarEmbarquesRoteiro(vector<Embarca> &vecResult, vector<Embarca> embarques, char codigo[12]){
    int i;
